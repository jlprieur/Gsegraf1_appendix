...
// Initialize extern variables (and p_window_data):
   GSEGraf_Init_PrivateVariables();

/* Initialize plot */
   jlp_gseg0 = new JLP_Gseg_Gnome(&p_window_data);
   jlp_gsegraf0 = new JLP_Gsegraf(jlp_gseg0, parameter_file, 
                                  &save_filename0, &close_flag);

// Initialize font family:
   jlp_gseg0->GSEG_gnome_SetPointersFromPlot(&font_text_0);
...
/* Create antialiased canvas */
   ...
   jlp_gseg0->GSEG_gnome_InitializePlotWindow(window, canvas);
...
* 
*****************************************************************************/
   void GSEGraf_Init_PrivateVariables() 
{
