...
#include "jlp_gsegraf.h" // in jlp_gsegraf

#include "jlp_gseg_gnome.h"         // in jlp_gseg_gnome
...
GSEGRAF_EXTERN JLP_Gseg_Gnome  *jlp_gseg0;
GSEGRAF_EXTERN JLP_Gsegraf  *jlp_gsegraf0;
